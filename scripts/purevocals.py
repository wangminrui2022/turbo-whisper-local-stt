...
# 基础用法
# python scripts\purevocals.py "F:\TestAudio" "F:\TestOutput"
# 指定高质量模型
# python scripts\purevocals.py "F:\TestAudio\audio.mp3" "F:\TestOutput" --model "6_HP-Karaoke-UVR.pth"
# 仅处理前30秒预览
# python scripts\purevocals.py "F:\TestAudio" "F:\TestOutput" --sample_mode
# 批量 + 最快模型
# python scripts\purevocals.py "F:\TestAudio" "F:\TestOutput" --model "UVR_MDXNET_KARA_2.onnx"
